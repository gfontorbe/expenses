...
function extractDocument(fileName, extensions, services) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const document = services.documents.LangiumDocuments.getOrCreateDocument(vscode_uri_1.URI.file(path_1.default.resolve(fileName)));
        ...
        if (validationErrors.length > 0) {
            ...
            for (const validationError of validationErrors) {
                console.error(colors_1.default.red(`line ${validationError.range.start.line}: ${validationError.message} [${document.textDocument.getText(validationError.range)}]`));
            }
            process.exit(1);
        }
        return document;
...
function extractAstNode(fileName, extensions, services) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        return (_a = (yield extractDocument(fileName, extensions, services)).parseResult) === null || _a === void 0 ? void 0 : _a.value;
    });
}
